...
configuration ConfigS2D
{
    ...
    Import-DscResource –ModuleName @{ModuleName="xComputerManagement"; RequiredVersion="1.2.2"}, @{ModuleName=”xFailOverCluster”}, @{ModuleName=”xActiveDirectory"}, @{ModuleName=”xSOFS"}, @{ModuleName=”xWaitForADDomain"}
